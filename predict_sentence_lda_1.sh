...
LDA_RISK='/mnt/nfs/scratch1/hshukla/sentence_results/window1_rerunsen_lda_item1a_risk_1.model'
LDA_MDA='/mnt/nfs/scratch1/hshukla/sentence_results/window1_rerunsen_lda_item7_mda_1.model'
